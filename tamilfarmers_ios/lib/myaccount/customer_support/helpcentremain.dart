...
import 'package:tamilfarmers_ios/myaccount/customer_support/helpcentre.dart';
...
import 'package:tamilfarmers_ios/myaccount/mywishlist/mywishlist.dart';
import 'package:tamilfarmers_ios/myaccount/notifications/notifications.dart';
...
class HelpcentreMain extends StatelessWidget {
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: cartappbar("24*7 Customer Support"),
      body: helpcentre(),
    );
  }
}
