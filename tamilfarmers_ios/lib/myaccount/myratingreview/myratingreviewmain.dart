...
import 'package:tamilfarmers_ios/myaccount/myratingreview/myratingreview.dart';
...
class MyratingreviewMain extends StatelessWidget {
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: cartappbar("My Ratings and Reviews"),
      body: myratingreview(),
    );
  }
}
