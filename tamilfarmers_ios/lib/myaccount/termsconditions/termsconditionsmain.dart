...
import 'package:tamilfarmers_ios/myaccount/termsconditions/termsconditions.dart';
...
class TermsconditionsMain extends StatelessWidget {
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: cartappbar("Terms and Conditions"),
